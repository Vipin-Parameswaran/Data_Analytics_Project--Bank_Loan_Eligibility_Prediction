...
#### I analyzed a loan dataset using 'Decision Tree Classifier', 'Gaussian Naive Bayes' and 'Random Forest Classifier' to predict loan repayment or default based on the following features:
...
### 6] Machine learning ('Decision Tree Classifier', 'Gaussian Naive Bayes', 'Random Forest Classifier')
